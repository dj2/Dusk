...
#include "src/example_03/webgpu_helpers.h"
#include "src/example_03/wgpu.h"
...
constexpr uint32_t index_data[3] = {0, 1, 2};
...
int main() {
  ...
  // Create buffers
  auto indexBuffer = dusk::webgpu::createBufferFromData(
      device, "Index Buffer", index_data, sizeof(index_data),
